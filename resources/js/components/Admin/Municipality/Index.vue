...
<div class="d-xl-flex">                
                        ...
                        <tbody>
                            <tr v-for="list in lists" v-bind:key="list.id">
                                ...
                                <td class="text-center">
                                    <router-link :to="{ path: '/municipality/'+list.id }" class="mr-3">
    ...
    <div class="modal fade exampleModal" id="new" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <muni-create @status="message" ref="create"></muni-create>
    </div>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        fetch(page_url) {
            ...
            page_url = page_url || this.currentUrl + '/request/municipalities/'+key+'/'+this.counts;
