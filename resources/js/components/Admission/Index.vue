                        ...
                        <tbody>
                            <tr v-for="list in lists" v-bind:key="list.id" :class="[(list.status.name == 'Active') ? 'bg-soft-warning' : '']">
                                ...
                                <td class="text-center">
                                    <h5 class="font-size-12 mb-0 text-dark">Floor {{list.bed.floor}} - Bed {{list.bed.name}}</h5>
                                    <p class="font-size-12 text-muted mb-0">{{list.bed.facility.name}}</p>
                                </td>
                                <td class="text-center">
                                    <h5 class="font-size-12 mb-0 text-dark">{{list.exit_port}}</h5>
                                    <p class="font-size-12 text-muted mb-0">{{list.arrived_at}}</p>
                                </td>
