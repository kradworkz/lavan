    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">RT PCR Result</h5>
            ...
            <div class="modal-body" style="margin-left: 10px; margin-right:10px;">
                ...
                <p class="text-center">Add RT-PCR Result to the patient <span class="text-primary font-weight-bold">{{ user.patient_name }} </span></p>
