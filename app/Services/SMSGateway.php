...
class SMSGateway {
    ...
    public static function sendSMS($message,$phone) 
    {
        ...
        $token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJhZG1pbiIsImlhdCI6MTY0Njk4ODcxNiwiZXhwIjo0MTAyNDQ0ODAwLCJ1aWQiOjkzMDU5LCJyb2xlcyI6WyJST0xFX1VTRVIiXX0.BYwB5LeyJpTNf1e2mlyNo2l1gYYAOXw31SR4cjMIOEk";
        $curl = curl_init();
